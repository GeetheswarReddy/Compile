...
def restrict_child():
    ...
    if machine == "x86_64":
        ...
        denied = [2, 85, 257, 304, 437, 41, 53, 56, 57, 58, 59, 62, 101, 200, 234, 272, 308, 310, 311, 322, 425, 426, 427, 435]
    elif machine == "aarch64":
        architecture = 0xC00000B7
        denied = [56, 265, 437, 198, 199, 220, 221, 129, 130, 131, 117, 97, 268, 270, 271, 281, 425, 426, 427, 435]
    else:
    ...
    # creation, filesystem opens (including /proc and Lambda credentials),
    # process signalling/inspection, namespace changes and io_uring.
