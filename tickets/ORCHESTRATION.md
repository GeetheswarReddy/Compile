...
| --- | --- | --- | --- | --- |
| T16 | `ticket_t16_resume` | Blocked on explicit deployment approval | None | 60 tests + SAM lint/build pass; live fallback deployment pending |
...
| T21 | `ticket_t21` | Local gate complete; live release blocked | T16–T20 | Full local suite and visual QA pass; deployed browser/API verification pending |
